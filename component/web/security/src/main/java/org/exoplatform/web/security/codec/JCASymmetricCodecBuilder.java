...
public class JCASymmetricCodecBuilder extends AbstractCodecBuilder
{
   ...
   {
      String transformation = config.get("gatein.codec.jca.symmetric.transformation");
      String keyFile = config.get("gatein.codec.jca.symmetric.key.file");
      String storeType = config.get("gatein.codec.jca.symmetric.key.store.type");
      String alias = config.get("gatein.codec.jca.symmetric.key.alias");
      char[] password = config.get("gatein.codec.jca.symmetric.key.password").toCharArray();
